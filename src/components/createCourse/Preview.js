...
import { duration } from "@mui/material";
 ...
 function Preview() {
    ...
    useEffect(() => {
            const updatedCourse=coursePreviewLocation.state;
        ...
        <Container>
            <Grid container spacing={1}>
                <Grid item xs={12} md={9} >
                    <Button onClick={()=>{navigate("/instructorDashboard");}}>Back to Instructor Dashboard</Button>
                    <Stack spacing={1}>
                        ...
                        <Paper variant="outlined">
                            ...
                            <Button disableRipple onClick={()=>{navigate(`/chapterAddtion/${courseId}`)}}>Add Chapter</Button>
                                    ...
                                    <Accordion key={index}
                                        ...
                                        <AccordionSummary expandIcon={<ExpandMoreIcon />}>
                                            <Box key={index} sx={{ display: "flex", justifyContent: "space-between" }}>
                                                ...
                                                <Button onClick={()=>{navigate(`/topicAddtion/${chapter?.publicId}`,{state:courseId})}}>Add Topic</Button>
                                            </Box>
                                        </AccordionSummary>
